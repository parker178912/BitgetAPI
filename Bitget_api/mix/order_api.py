...
class OrderApi(Client):
    ...
    def placeOrder(self, symbol: str, marginCoin: str, size: str, side: str, orderType: str, clientOrderId: str='', price: str='', timeInForceValue: str='normal', reduceOnly: bool=False, presetTakeProfitPrice: str='', presetStopLossPrice: str=''):
        '''
        ### Place an order
    ...
    def batch_orders(self, symbol: str, marginCoin: str, orderDataList: list[dict]):
        ...
        orderDataList: 
            ...
            presetStopLossPrice: Preset stop loss price, ex: "1960.32"
        '''
        params = {'symbol': symbol, 'marginCoin': marginCoin, 'orderDataList': orderDataList}
        return self._request_with_params(POST, MIX_ORDER_V1_URL + '/batch-orders', params)

    def cancel_orders(self, symbol: str, marginCoin: str, orderId: str='', clientOid: str=''):
        '''
    ...
    def cancel_batch_orders(self, symbol: str, marginCoin: str, orderIds: list=[], clientOids: list=[]):
        '''
        ### Batch cancellation
        symbol: Contract transaction pair, ex: "BTCUSDT_UMCBL"
        marginCoin: Deposit currency, ex: "USDT"\\
        ...
        if symbol and marginCoin and (orderIds or clientOids):
            params = {'symbol': symbol, 'marginCoin':marginCoin, 'orderIds': orderIds, 'clientOids': clientOids}
            return self._request_with_params(POST, MIX_ORDER_V1_URL + '/cancel-batch-orders', params)
        else:
            return "pls check args "
        
    def modifyOrder(self, symbol: str, orderId: str='', clientOid: str='', newClientOid: str='', size: str= '', price: str='', presetTakeProfitPrice: str='', presetStopLossPrice: str=''):
        '''
    ...
    def cancel_symbol_orders(self, symbol: str, marginCoin: str):
        ...
        if symbol and marginCoin:
            params["symbol"] = symbol
            params["marginCoin"] = marginCoin
            return self._request_with_params(POST, MIX_ORDER_V1_URL + '/cancel-symbol-orders', params)
        else:
            return "pls check args "
    ...
    def historyProductType(self, productType: str, startTime: str, endTime: str, pageSize: str, lastEndId: str='', clientOid: str='', isPre: bool=False):
        '''
    ...
    def fills(self, symbol: str, orderId: str='', startTime: str='', endTime: str='', lastEndId: str=''):
        '''
    ...
    def allFills(self, productType: str, startTime: str, endTime: str, lastEndId: str=''):
        '''
